...
if ($products->num_rows > 0) {
    ...
    $stoc = $inv[0]['quantity'];
    $query = "SELECT SUM(quantity)as value_sum FROM order_list WHERE product_id = " . $id;
    $select_order = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($select_order);
    $ordered = $row['value_sum'];
    $avail = $stoc - $ordered;
}
    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="mt-2 row gx-2 gx-lg-3 row-cols-4 row-cols-md-3 row-cols-xl-4 justify-content-start">
                    ...
                    foreach ($fileO as $k => $img):
                        ...
                        if (isset($_POST['recenzie_commit'])) {
                            ...
                            $query = "INSERT INTO review(id_carte, id_user, continut_recenzie, data) ";
                            $query .= "VALUE('{$_GET['carte_id']}', {$_settings->userdata('id')}, '{$recenzie}', '{$current_date}') ";

                            $add_recenzie_query = mysqli_query($conn, $query);
            ...
            <div class="col-md-6">
                ...
                <p class="m-0"><small>De: <?php echo $author ?></small></p>
                <div class="fs-5 mb-5">

                    <b>Preț: <span id="price">
                            <?php echo number_format($inv[0]['price']) ?>
                        </span> lei</b>
                    <br>
                    <span><small><b>Stoc:</b><b> <span id="avail"><?php /*echo $inv[0]['quantity']*/echo $avail ?></span></small></span></b> <b>bucăți</b>
                </div>
            ...
            <div class="well col-md-12">
                        ...
                        <?php
                        $query = "SELECT * FROM review LEFT JOIN users ON review.id_user = users.id WHERE id_carte = {$_GET['carte_id']}";
                        $select_recenzii = mysqli_query($conn, $query);
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Recomandări</h2>
                    ...
                    <div class="card h-100 product-item">
                        ...
                        <div class="card-body p-4">
                            <div class="">
                                ...
                                <?php endforeach; ?>
                                <p class="m-0"><small>De: <?php echo $row['author'] ?></small></p>
                            </div>
                        </div>
                        <!-- Product actions-->
